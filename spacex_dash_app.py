...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        #print(filtered_df)
        fig = px.pie(filtered_df, values='Flight Number', names=filtered_df.index, title=f"total Success Launches By Site ({entered_site})")
        return fig
...
@app.callback(Output(component_id="success-payload-scatter-chart", component_property="figure"),
              ...
              Input(component_id='site-dropdown', component_property='value')])
def get_scatter_chart(slider,site):
    #filtered_df = spacex_df
    if site == "ALL":
        #print(slider)
        filtered_df = spacex_df[spacex_df["Payload Mass (kg)"] < slider[1]]
        filtered_df = filtered_df[spacex_df["Payload Mass (kg)"] > slider[0]]
        ...
        filtered_df = filtered_df[spacex_df["Payload Mass (kg)"] < slider[1]]
        filtered_df = filtered_df[spacex_df["Payload Mass (kg)"] > slider[0]]
